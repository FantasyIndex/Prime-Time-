        ...
        {phase === "gate" && (
          <div style={{ width: "100%", maxWidth: "600px" }}>
            ...
            <form onSubmit={handleGate} className="poll-card" style={{ background: "white", borderRadius: "6px", boxShadow: "0 2px 16px rgba(0,0,0,0.07)" }}>
              <div style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 700, fontSize: "1.1rem", letterSpacing: "0.12em", color: "var(--ink)", marginBottom: "6px" }}>Want to Keep Taking Polls?</div>
              <p style={{ fontSize: "0.85rem", color: "var(--mid)", marginBottom: "20px", lineHeight: 1.6 }}>Sign up free to get new polls every week, see full results, and get exclusive picks from the Prime Time Sports crew.</p>
